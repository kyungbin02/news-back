            ...
            if (valid) {
                try {
                    ...
                    if (isCommentRequest) {
                        ...
                        System.out.println("[JwtAuthenticationFilter] 🔔 알림 API - 토큰에서 추출한 username: " + username);
                        System.out.println("[JwtAuthenticationFilter] 🔔 알림 API - 토큰에서 추출한 userId: " + userId);
                        System.out.println("[JwtAuthenticationFilter] 🔔 알림 API - 토큰에서 추출한 isAdmin: " + isAdmin);
                    } else {
                    ...
                    if (username != null && userId != null) {
                        ...
                        if (isCommentRequest) {
                            ...
                            System.out.println("[JwtAuthenticationFilter] 🔔 알림 API - SecurityContext에 인증 정보 설정 완료 ✅");
                        } else {
                    ...
                    if (isCommentRequest) {
                        ...
                        System.err.println("[JwtAuthenticationFilter] 🔔 알림 API - JWT 처리 중 예외 발생:");
                    } else {
                ...
                if (isCommentRequest) {
                    ...
                    System.err.println("[JwtAuthenticationFilter] 🔔 알림 API - 토큰이 유효하지 않음 ❌");
                }
            }
        } else {
            if (isCommentRequest) {
                ...
                System.err.println("[JwtAuthenticationFilter] 🔔 알림 API - 토큰이 없거나 비어있음 ❌");
            } else {
